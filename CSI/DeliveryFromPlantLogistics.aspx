<%@ Page Title="Delivery From Plant" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="DeliveryFromPlantLogistics.aspx.cs" Inherits="CSI.DeliveryFromPlantLogistics" %>
                                            ...
                                            <div class="col-sm-3 text-right">
                                                <div class="input-group">
                                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator113" runat="server" InitialValue="0" 
                                                            ControlToValidate="ddCategory"  Display="Dynamic" ValidationGroup="grpOrder" ForeColor="Red"
                                                           ...
                                                           <asp:DropDownList ID="ddCategory" runat="server" class="form-control" Style="width: 135px;  text-transform:uppercase;" >
                                                              <%--      <asp:ListItem Value="0" Text="Select Category" Selected="True"></asp:ListItem>
                                                                    <asp:ListItem Value="8" Text="E-Commerce"></asp:ListItem>     
                                                                    <asp:ListItem Value="5" Text="Regular Clinic Supplies"></asp:ListItem>
                                                                    <asp:ListItem Value="6" Text="Online Selling"></asp:ListItem>
                                                                    <asp:ListItem Value="7" Text="RGAS"></asp:ListItem>--%>
                                             ...
                                             <div class="col-sm-1 col-1 text-right">
                                                 <div class="input-group" >
                                                     <asp:Button ID="btnPost" runat="server" Text="P O S T" ValidationGroup="grpOrder"  OnClientClick="if(Page_ClientValidate()) ShowProgress()" CssClass="btn btn-sm btn-primary" OnClick="btnPost_Click"  />
                                                 </div>
                                             </div>
