<%@ Page Title="CSI System | RGAS Entry" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="RGASEntry.aspx.cs" Inherits="CSI.RGASEntry" %>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div style="margin-bottom: 5px" class="input-group">
                                <div class="col-md-2 col-2 text-left">
                                    <asp:Label ID="Label4" runat="server" Text="Payment Type" Style="width: 125px;"></asp:Label>
                                </div>
                                <div class="col-lg-2 col-2">
                                    <div class="input-group">
                                        <asp:DropDownList ID="ddPaymentType" runat="server" class="form-control" Style="width: 135px;">
                                            <asp:ListItem Value="Cash" Text="Cash" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="Salary Deduction" Text="Salary Deduction"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            ...
                            <div style="margin-bottom: 5px" class="input-group">
                                    <div class="col-md-2 col-2 text-left">
                                        <asp:Label ID="Label1" runat="server" Text="Receipt No." style="width:125px;"></asp:Label>
                                    </div>
                                  ...
                                  <div class="col-lg-7 col-7">
                                          <div class="input-group">
                                                <asp:RequiredFieldValidator ID="ReqReceiptNo" runat="server" 
                                                            ControlToValidate="txtReceiptNo"  Display="Dynamic" ValidationGroup="grpRGAS" ForeColor="Red"
                                                            ErrorMessage="Required"></asp:RequiredFieldValidator>
                                          </div>
                                  ...
                                  <div class="col-lg-6 col-6">
                                          <div class="input-group">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                            ControlToValidate="txtCustomerName"  Display="Dynamic" ValidationGroup="grpRGAS" ForeColor="Red"
                                                            ErrorMessage="Required"></asp:RequiredFieldValidator>
                                          </div>
                ...
                <asp:GridView ID="gvItemBatch" runat="server" AutoGenerateColumns="false" OnRowUpdating="gvItemBatch_RowUpdating">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="SRP" ItemStyle-Width="70px" HeaderStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtSRP" runat="server" CssClass="form-control decimalnumbers-only" Width="65px" AutoCompleteType="Disabled" autocomplete="off"></asp:TextBox>
