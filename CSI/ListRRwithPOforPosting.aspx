<%@ Page Title="RR for Posting" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ListRRwithPOforPosting.aspx.cs" Inherits="CSI.ListRRwithPOforPosting" %>
                            ...
                            <asp:GridView ID="gvRR" runat="server" Width="100%"  class="table table-bordered table-hover" DataKeyNames="RecNum" AutoGenerateColumns="false" OnRowCancelingEdit="gvRR_RowCancelingEdit" OnRowEditing="gvRR_RowEditing" OnRowUpdating="gvRR_RowUpdating" OnRowCommand="gvRR_RowCommand" OnRowDeleting="gvRR_RowDeleting">
                                <Columns>
                                   ...
                                   <asp:BoundField DataField="sup_ItemCode" HeaderText="Item Code" HtmlEncode="false" ItemStyle-Width="8%" ReadOnly="true" HeaderStyle-HorizontalAlign="Center">
                                      ...
                                      <asp:TemplateField HeaderText="PO Price" ItemStyle-Width="7%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblsup_UnitCost" runat="server" Text='<%#Eval("sup_UnitCost","{0:#,###0.#0}") %>'></asp:Label>
                                                    </ItemTemplate>
                                         </asp:TemplateField>

                                    
                                    <asp:TemplateField HeaderText="RR Quantity<br />(From Purchasing)" ItemStyle-Width="5%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblPOQuantity" runat="server" Text='<%#Eval("POQuantity") %>'></asp:Label>
                                                    </ItemTemplate>
                                         </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Edited Price" ItemStyle-Width="7%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right">
                                             ...
                                             <EditItemTemplate>
                                                      <asp:TextBox ID="txtsup_RetailCost" runat="server" CssClass="form-control  decimalnumbers-only" Text='<%#Eval("sup_RetailCost","{0:#,###0.#0}") %>' Width="95px" AutoCompleteType="Disabled"  autocomplete="off"></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="Edited <br />Quantity" ItemStyle-Width="5%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblvQtyReceived" runat="server" Text='<%#Eval("vQtyReceived") %>'></asp:Label>
                                                    </ItemTemplate>
                                        <EditItemTemplate>
                                                      <asp:TextBox ID="txtvQtyReceived" runat="server" CssClass="form-control  decimalnumbers-only" Text='<%#Eval("vQtyReceived") %>' Width="95px" AutoCompleteType="Disabled"  autocomplete="off"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator17827" runat="server" ErrorMessage="Required"  
                                                            ControlToValidate="txtvQtyReceived" ValidationGroup='<%# "Grp2-" + Container.DataItemIndex %>'  ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                    ...
                                    <%--<asp:TemplateField HeaderText="Total Amount" ItemStyle-Width="7%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblTotalAmount" runat="server" Text='<%#Eval("TotalAmount","{0:N2}") %>'></asp:Label>
                                                    </ItemTemplate>
                                         </asp:TemplateField>--%>
                                     ...
                                     <asp:TemplateField HeaderText="Total Amount" ItemStyle-Width="5%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right">
                                        ...
                                        <EditItemTemplate>
                                                      <asp:TextBox ID="txtTotalAmount" runat="server" CssClass="form-control decimalnumbers-only" Text='<%#Eval("TotalAmount") %>' Width="95px" AutoCompleteType="Disabled"  autocomplete="off"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1782297" runat="server" ErrorMessage="Required"  
