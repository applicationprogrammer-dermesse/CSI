...
namespace CSI
{
    public partial class ReportDeliveryFromPlant : System.Web.UI.Page
    {
        ...
        protected void gvDelivery_PreRender(object sender, EventArgs e)
        {
            if (gvDelivery.Rows.Count > 0)
            {
                gvDelivery.UseAccessibleHeader = true;
                gvDelivery.HeaderRow.TableSection = TableRowSection.TableHeader;
                gvDelivery.FooterRow.TableSection = TableRowSection.TableFooter;
            }
        }
