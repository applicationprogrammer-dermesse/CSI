<%@ Page Title="For Approval" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ForApproval.aspx.cs" Inherits="CSI.ForApproval" %>
        ...
        function ShowMsgSuccessPosting() {
            $(function () {
                $("#messageSuccessPosting").dialog({
                    ...
                    buttons: {
                        Close: function () {
                            window.location = '<%= ResolveUrl("~/ListForApprovalBranchHead.aspx") %>';
                            $(this).dialog('close');
                        }
                    },
                    modal: true
