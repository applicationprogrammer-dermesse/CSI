<%@ Page Title="Issuance Clinic Supplies" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="IssuanceClinicSupplies.aspx.cs" Inherits="CSI.IssuanceClinicSupplies" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5>Isuance of Clinic Suppplies (By Department)</h5>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="col-sm-12 text-center">
                                   ...
                                   <asp:GridView ID="gvPicked" CssClass="table table-bordered active active" DataKeyNames="vRecNum" AutoGenerateColumns="false" runat="server" OnRowDeleting="gvPickedItems_RowDeleting">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Sup_ControlNo" HeaderText="No" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center"/>
...
<script type="text/javascript">
    function ShowSuccessMsg() {
        $(function () {
            $("#messageDiv").dialog({
                title: "Issuance Clinic Supplies",
                width: '335px',
                buttons: {
                    Close: function () {
                        $(this).dialog('close');
