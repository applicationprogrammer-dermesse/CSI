<%@ Page Title="List of Approved Request" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ListOfApprovedRequest.aspx.cs" Inherits="CSI.ListOfApprovedRequest" %>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">List of Approved Request</h3>
                        </div>
                     <div class="card-body">

                            <%--start--%>
                            <asp:GridView ID="gvApproved" runat="server" Width="100%" ClientIDMode="Static"  class="table table-bordered table-hover" DataKeyNames="Sup_ControlNo" AutoGenerateColumns="false" OnRowCommand="gvApproved_RowCommand" OnPreRender="gvApproved_PreRender">
                                <Columns>
                                   ...
                                   <asp:BoundField DataField="BrName" HeaderText="Branch" ItemStyle-Width="15%" HeaderStyle-HorizontalAlign="Center">
                                    ...
                                    <asp:BoundField DataField="Sup_EncodedBy" HeaderText="Encoded By" ItemStyle-Width="15%" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    </asp:BoundField>
                                    
                                    
                                    <asp:BoundField DataField="Sup_CategoryNum" HeaderText="CN" ItemStyle-Width="3%" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    </asp:BoundField>
    ...
    <script>
        $(function () {
            $("#<%=gvApproved.ClientID%>").DataTable({
                ...
                "responsive": true,
            }).buttons().container().appendTo('#gvApproved_wrapper .col-md-6:eq(0)');;
        });
</script>
