<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportDeliveryFromPlant.aspx.cs" Inherits="CSI.ReportDeliveryFromPlant" %>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                            ...
                            <div class="col-sm-4 col-4">
                                <div class="input-group">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Display="Dynamic"
                                        ControlToValidate="txtDateFrom" ForeColor="Red" ValidationGroup="grpDelivery"
                                    ...
                                    <asp:RegularExpressionValidator ID="REVdate" runat="server" ControlToValidate="txtDateFrom"
                                        ...
                                        ValidationGroup="grpDelivery"></asp:RegularExpressionValidator>
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" Style="color: Red;"
                                        ValidationGroup="grpDelivery" Display="Dynamic" ControlToCompare="txtDateFrom"
                            ...
                            <div class="col-sm-4 col-4">
                                <div class="input-group">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDateTo" ForeColor="Red" Display="Dynamic"
                                        ValidationGroup="grpDelivery" ErrorMessage="Required Field"></asp:RequiredFieldValidator>
                        ...
                        <div style="margin-bottom: 5px" class="input-group">
                            ...
                            <div class="col-sm-2 col-2">
                                <asp:Button ID="btnGenerate" runat="server" Text="GENERATE" CssClass="btn btn-sm btn-info" ValidationGroup="grpDelivery" OnClick="btnGenerate_Click"  />
                            </div>
                            <div class="col-sm-4 col-4">
                                <div class="input-group">
                                </div>
                     ...
                     <div class="card-body">
                             <asp:GridView ID="gvDelivery" runat="server" ClientIDMode="Static" class="table table-bordered table-hover" AutoGenerateColumns="false" OnPreRender="gvDelivery_PreRender" >
                        <Columns>
                            ...
                            <asp:BoundField DataField="DR_Number" HeaderText="DR No." HtmlEncode="false" ItemStyle-Width="5%" HeaderStyle-HorizontalAlign="Center">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </asp:BoundField>

                            <asp:BoundField DataField="MRFNo" HeaderText="MRF No." ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="vQty" HeaderText="Quantity" DataFormatString="{0:#,##0.##;(#,##0.##);0}" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="DeliveredBy" HeaderText="Delivered By" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:BoundField>

                            <asp:BoundField DataField="vPostedDate" HeaderText="Date Posted" DataFormatString="{0:MM/dd/yyyy}" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:BoundField>

                            <asp:BoundField DataField="vPostedBy" HeaderText="Posted By" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:BoundField>
    ...
    <script>
        $(function () {
            $("#<%= gvDelivery.ClientID%>").DataTable({
                ...
                "autoWidth": false,
                "responsive": true,
            }).buttons().container().appendTo('#gvDelivery_wrapper .col-md-6:eq(0)');;
        });
    </script>
