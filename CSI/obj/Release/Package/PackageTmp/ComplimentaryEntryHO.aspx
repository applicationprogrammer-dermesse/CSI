<%@ Page Title="CSI System | Complimentary Entry" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ComplimentaryEntryHO.aspx.cs" Inherits="CSI.ComplimentaryEntryHO" %>
                        ...
                        <div class="card-header">
                            <div style="margin-bottom: 5px" class="input-group">
                                ...
                                <div class="col-lg-7 col-7">
                                    <div class="input-group">
                                        <asp:RequiredFieldValidator ID="ReqDate" runat="server"
                                            ControlToValidate="txtDate" Display="Dynamic" ValidationGroup="grpComplimentary" ForeColor="Red"
                                ...
                                <div class="col-lg-1 col-1 text-right">
                                    <div class="input-group">
                                        <asp:Button ID="btnPost" runat="server" Text="P O S T" CssClass="btn btn-primary" ValidationGroup="grpComplimentary" OnClientClick="if(Page_ClientValidate()) ShowProgress()" OnClick="btnPost_Click" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="margin-bottom: 5px" class="input-group">
                                    <div class="col-md-2 col-2 text-left">
                                        <asp:Label ID="Label1" runat="server" Text="Complimentary No." style="width:125px;"></asp:Label>
                                    </div>
                                     <div class="col-lg-3 col-3">
                                          <div class="input-group">
                                                        <asp:TextBox ID="txtReceiptNo" runat="server" class="form-control" style="text-transform:uppercase;" onkeydown="return (event.keyCode!=13);" autocomplete="off" AutoCompleteType="Disabled"></asp:TextBox>
                                         </div>
                                     </div>
                                  <div class="col-lg-7 col-7">
                                          <div class="input-group">
                                                <asp:RequiredFieldValidator ID="ReqReceiptNo" runat="server" 
                                                            ControlToValidate="txtReceiptNo"  Display="Dynamic" ValidationGroup="grpComplimentary" ForeColor="Red"
                                                            ErrorMessage="Required"></asp:RequiredFieldValidator>
                                          </div>
                            ...
                            <div style="margin-bottom: 5px" class="input-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        ...
                                        ControlToValidate="ddCategory"  Display="Dynamic" ValidationGroup="grpShow" ForeColor="Red"
...
<script type="text/javascript">
    function ShowSuccessMsg() {
        $(function () {
            $("#messageDiv").dialog({
                title: "Complimentary Data Entry",
                width: '335px',
                buttons: {
                    Close: function () {
                        $(this).dialog('close');
                ...
                <asp:GridView ID="gvItemBatch" runat="server" AutoGenerateColumns="false" OnRowUpdating="gvItemBatch_RowUpdating">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="SRP" ItemStyle-Width="70px" HeaderStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtSRP" runat="server" CssClass="form-control decimalnumbers-only" Width="65px" Text="0" ReadOnly="true" AutoCompleteType="Disabled" autocomplete="off"></asp:TextBox>
