<%@ Page Title="For Approval - MRF" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ForApprovalMRF.aspx.cs" Inherits="CSI.ForApprovalMRF" %>
                         ...
                         <div class="card">
                            <div class="card-header">
                                    ...
                                    <div class="col-sm-1 col-1 text-left">
                                     ...
                                     <div class="col-md-1 col-1 text-right">
                                         <div class="input-group" >
                                             ...
                                             <asp:Button ID="btnApprovedBr" runat="server" Text="APPROVE"  CssClass="btn btn-sm btn-info" OnClick="btnApprovedBr_Click" />
                                         </div>
                                     </div>
                                ...
                                <div style="margin-bottom: 10px" class="input-group">
                                  ...
                                  <div style="margin-bottom: 10px" class="input-group">
                                     <asp:Label ID="Label6" runat="server" Text="Date Required" style="width:125px;"></asp:Label>
                                     <asp:Label ID="lblDateRequired" runat="server" Text=""></asp:Label>
                                 </div>
                           ...
                           <div class="card-body">
                            ...
                            <asp:GridView ID="gvForApproval" runat="server" Width="100%"  class="table table-bordered table-hover" DataKeyNames="Sup_RequestID" AutoGenerateColumns="false" OnRowCancelingEdit="gvForApproval_RowCancelingEdit" OnRowDeleting="gvForApproval_RowDeleting" OnRowEditing="gvForApproval_RowEditing" OnRowUpdating="gvForApproval_RowUpdating">
                                <Columns>
                                   ...
                                   <asp:BoundField DataField="EndingBal" HeaderText="Balance<br/>(Logistics)" HtmlEncode="false" ItemStyle-Width="10%" ReadOnly="true" HeaderStyle-HorizontalAlign="Center"  ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    </asp:BoundField>
        ...
        function ShowMsgSuccessPosting() {
            $(function () {
                $("#messageSuccessPosting").dialog({
                    ...
                    buttons: {
                        Close: function () {
                            window.location = '<%= ResolveUrl("~/ListOfForApproval.aspx") %>';
                            $(this).dialog('close');
                        }
                    },
                    modal: true
