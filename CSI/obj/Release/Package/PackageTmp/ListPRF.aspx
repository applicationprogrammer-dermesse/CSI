<%@ Page Title="PRF for Posting" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ListPRF.aspx.cs" Inherits="CSI.ListPRF" %>
                            ...
                            <div class="card-header">
                                ...
                                <div style="margin-bottom: 5px" class="input-group">
                                        <div class="col-md-2 col-2 text-right">
                                            <asp:Label ID="Label2" runat="server" Text=" " style="width:125px; text-align: right;" ></asp:Label>
                                        </div>
                                         <div class="col-lg-10 col-10">
                                             <div class="input-group" >
                                                 <asp:Label ID="Label4" runat="server" ForeColor="Maroon" Text="Note: Check RGAS Item column if the item will go to RGAS Inventory"></asp:Label>
                                             </div>
                                         </div>
                                 </div>
                             ...
                             <div class="card-body">
                                <div class="col-sm-12">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="BrName" HeaderText="Branch" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center" />
                                        ...
                                        <asp:BoundField DataField="vPickedBy" HeaderText="Encoded By" ReadOnly="True">
                                           ...
                                           <asp:BoundField DataField="Remarks" HeaderText="Reason of Return" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Center" />
