<%@ Page Title="Report PRF" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="reportPRF.aspx.cs" Inherits="CSI.reportPRF" %>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                            ...
                            <div class="col-sm-4 col-4">
                                <div class="input-group">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Display="Dynamic"
                                        ControlToValidate="txtDateFrom" ForeColor="Red" ValidationGroup="grpPRF"
                                    ...
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" Style="color: Red;"
                                        ValidationGroup="grpPRF" Display="Dynamic" ControlToCompare="txtDateFrom"
                            ...
                            <div class="col-sm-4 col-4">
                                <div class="input-group">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDateTo" ForeColor="Red" Display="Dynamic"
                                        ValidationGroup="grpPRF" ErrorMessage="Required Field"></asp:RequiredFieldValidator>
                        ...
                        <div style="margin-bottom: 5px" class="input-group">
                            ...
                            <div class="col-sm-2 col-2">
                                <asp:Button ID="btnGenerate" runat="server" Text="GENERATE" CssClass="btn btn-sm btn-info" ValidationGroup="grpPRF" OnClick="btnGenerate_Click"  />
                            </div>
                            <div class="col-sm-4 col-4">
                                <div class="input-group">
                                </div>
                     ...
                     <div class="card-body">
                             <asp:GridView ID="gvPRF" runat="server" ClientIDMode="Static" class="table table-bordered table-hover" AutoGenerateColumns="false" OnPreRender="gvPRF_PreRender" >
                        <Columns>
                            
                            <asp:BoundField DataField="TransactionNo" HeaderText="ID" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"/>

                            <asp:BoundField DataField="BrName" HeaderText="Branch/Dept." ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </asp:BoundField>
                            
                            <asp:BoundField DataField="ReceiptNo" HeaderText="PRF NO." ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </asp:BoundField>
    ...
    <script>
        $(function () {
            $("#<%= gvPRF.ClientID%>").DataTable({
                ...
                "autoWidth": false,
                "responsive": true,
            }).buttons().container().appendTo('#gvPRF_wrapper .col-md-6:eq(0)');;
        });
    </script>
