<%@ Page Title="E-comm Free Entry Page" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EcommerceFreeEntry.aspx.cs" Inherits="CSI.EcommerceFreeEntry" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5>E-Commerce(Free/Complimentary Item) Data Entry</h5>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div style="margin-bottom: 5px" class="input-group">
                             ...
                             <div style="margin-bottom: 5px" class="input-group">
                                <div class="col-md-2 col-2 text-left">
                                    <asp:Label ID="Label2" runat="server" Text="Customer : " Style="width: 125px;"></asp:Label>
                                </div>
                                <div class="col-lg-6 col-6">
                                    <div class="input-group">
                                        <asp:TextBox ID="txtCustomer" runat="server" class="form-control" Style="text-transform: uppercase;" onkeydown="return (event.keyCode!=13);" autocomplete="off" AutoCompleteType="Disabled"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-2">
                                    <div class="input-group">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                            ControlToValidate="txtCustomer" Display="Dynamic" ValidationGroup="grpOrder" ForeColor="Red"
                                            ErrorMessage="Required"></asp:RequiredFieldValidator>
                                    </div>
                             ...
                             <div style="margin-bottom: 5px" class="input-group">
                                <div class="col-md-2 col-2 text-left">
                                    <asp:Label ID="Label4" runat="server" Text="Type : " Style="width: 125px;"></asp:Label>
                                </div>
                                <div class="col-lg-3 col-3">
                                    <div class="input-group">
                                        <asp:DropDownList ID="ddType" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddType_SelectedIndexChanged">
                                            ...
                                            <asp:ListItem Value="2" Text="Complimentary" ></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-lg-7 col-7">
                                    <div class="input-group">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" InitialValue="0"
                                            ControlToValidate="ddType" Display="Dynamic" ValidationGroup="grpOrder" ForeColor="Red"
                                ...
                                <div class="col-sm-12 text-center">
                                    <asp:GridView ID="gvPicked" CssClass="table table-bordered active active" DataKeyNames="OrderID" AutoGenerateColumns="false" runat="server" OnRowDeleting="gvPickedItems_RowDeleting">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="sup_DESCRIPTION" HeaderText="Item Description" ItemStyle-Width="30%" ItemStyle-HorizontalAlign="Center" />
