<%@ Page Title="Report Adjustment" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportAdjustments.aspx.cs" Inherits="CSI.ReportAdjustments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                            ...
                            <div class="col-sm-4 col-4">
                                <div class="input-group">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Display="Dynamic"
                                        ControlToValidate="txtDateFrom" ForeColor="Red" ValidationGroup="grpAdjustment"
                                    ...
                                    <asp:RegularExpressionValidator ID="REVdate" runat="server" ControlToValidate="txtDateFrom"
                                        ...
                                        ValidationGroup="grpAdjustment"></asp:RegularExpressionValidator>
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" Style="color: Red;"
                                        ValidationGroup="grpAdjustment" Display="Dynamic" ControlToCompare="txtDateFrom"
                            ...
                            <div class="col-sm-4 col-4">
                                <div class="input-group">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDateTo" ForeColor="Red" Display="Dynamic"
                                        ValidationGroup="grpAdjustment" ErrorMessage="Required Field"></asp:RequiredFieldValidator>
                        ...
                        <div style="margin-bottom: 5px" class="input-group">
                            ...
                            <div class="col-sm-2 col-2">
                                <asp:Button ID="btnGenerate" runat="server" Text="GENERATE" CssClass="btn btn-sm btn-info" ValidationGroup="grpAdjustment" OnClick="btnGenerate_Click"  />
                            </div>
                            <div class="col-sm-4 col-4">
                                <div class="input-group">
                                </div>
                     ...
                     <div class="card-body">
                             <asp:GridView ID="gvAdjustment" runat="server" ClientIDMode="Static" class="table table-bordered table-hover" AutoGenerateColumns="false" OnPreRender="gvAdjustment_PreRender" >
                        <Columns>
                            ...
                            <asp:BoundField DataField="TransactionNo" HeaderText="Adjustment No." ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="vQtyPicked" HeaderText="Quantity" DataFormatString="{0:#,##0.##;(#,##0.##);0}" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="vDateEncoded" HeaderText="Date Encoded" DataFormatString="{0:MM/dd/yyyy}" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:BoundField>
      
                            <asp:BoundField DataField="vPickedBy" HeaderText="Encoded By" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:BoundField>

                            <asp:BoundField DataField="DatePostedHO" HeaderText="Date Posted HO" DataFormatString="{0:MM/dd/yyyy}" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:BoundField>
 ...
 <div class="loading" align="center" style="margin-top:100px;">
    ...
    <script>
        $(function () {
            $("#<%= gvAdjustment.ClientID%>").DataTable({
                "paging": true,
                "lengthChange": true,
                "searching": true,
                "ordering": false,
                ...
                "autoWidth": false,
                "responsive": true,
            }).buttons().container().appendTo('#gvAdjustment_wrapper .col-md-6:eq(0)');;
        });
    </script>
