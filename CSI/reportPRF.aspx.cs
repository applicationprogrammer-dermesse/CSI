...
namespace CSI
{
    public partial class reportPRF : System.Web.UI.Page
    {
        ...
        protected void gvPRF_PreRender(object sender, EventArgs e)
        {
            if (gvPRF.Rows.Count > 0)
            {
                gvPRF.UseAccessibleHeader = true;
                gvPRF.HeaderRow.TableSection = TableRowSection.TableHeader;
                gvPRF.FooterRow.TableSection = TableRowSection.TableFooter;
            }
        }
