<%@ Page Title="Complimentary - For Posting" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ListComplimentary.aspx.cs" Inherits="CSI.ListComplimentary" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
     <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5>List of Complimentary for Posting</h5>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="card-header">
                                  ...
                                  <div style="margin-bottom: 5px" class="input-group">
                                      ...
                                      <div class="col-lg-4 col-4">
                                        ...
                                        <div class="col-lg-1 col-1 text-right">
                                             <div class="input-group" >
                                                 <asp:Button ID="btnPost" runat="server" Text="P O S T" CssClass="btn btn-primary" ValidationGroup="grpSave" OnClick="btnPost_Click" OnClientClick="if(Page_ClientValidate()) ShowProgress()"/>
                                             </div>
                                         </div>
                                 </div>
                                <div style="margin-bottom: 5px" class="input-group">
                                        <div class="col-md-2 col-2 text-left">
                                         ...
                                         <div class="col-lg-5 col-5">
                                             <div class="input-group" >
                                                 <asp:DropDownList ID="ddComplimentaryNo" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddComplimentaryNo_SelectedIndexChanged" ></asp:DropDownList>
                                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddComplimentaryNo" InitialValue="0" ForeColor="Red" ValidationGroup="grpSave"
                                                     ErrorMessage="Please select Complimentary No"></asp:RequiredFieldValidator>
                                             </div>
                                         </div>
                                 </div>
                             ...
                             <div class="card-body">
                                <div class="col-sm-12">
                                        ...
                                        <asp:GridView ID="gvPicked" ClientIDMode="Static" CssClass="table table-bordered active active" DataKeyNames="vRecNum" AutoGenerateColumns="false" runat="server" OnRowDeleting="gvPicked_RowDeleting" OnPreRender="gvPicked_PreRender">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="BrName" HeaderText="Branch" ItemStyle-Width="14%" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="ReceiptNo" HeaderText="No." ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center" />
                                        ...
                                        <asp:BoundField DataField="vPickedBy" HeaderText="Encoded By" ReadOnly="True">
                                               ...
                                               <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnDeleteCompli" runat="server" CommandName="Delete" Text="" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></asp:LinkButton>
                                                    </ItemTemplate>
...
<script type="text/javascript">
    function ShowSuccessMsg() {
        $(function () {
            $("#messageDiv").dialog({
                title: "Posting of Complimentary",
                width: '335px',
                buttons: {
                    Close: function () {
                        $(this).dialog('close');
