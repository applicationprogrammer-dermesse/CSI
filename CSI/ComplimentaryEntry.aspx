<%@ Page Title="CSI System | Complimentary" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ComplimentaryEntry.aspx.cs" Inherits="CSI.ComplimentaryEntry" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
     <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5>Complimentary Data Entry</h5>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                         ...
                         <div class="card">
                            <div class="card-header">
                                ...
                                <div style="margin-bottom: 5px" class="input-group">
                                    <div class="col-md-2 col-2 text-left">
                                        <asp:Label ID="Label8" runat="server" Text="Complimentary No" style="width:125px;"></asp:Label>   
                                    </div>
                                     <div class="col-lg-3 col-3">
                                         <div class="input-group" >
                                             <asp:TextBox ID="txtComplimentaryNumber" runat="server" CssClass="form-control" Width="105px" ValidationGroup="grpSave"  onkeydown = "return (event.keyCode!=13);" AutoCompleteType="Disabled" onfocus="disableautocompletion(this.id);" ReadOnly="true"></asp:TextBox>
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator4"  Display="Dynamic" runat="server" ControlToValidate="txtComplimentaryNumber" ForeColor="Red" ValidationGroup="grpSave"
                           ...
                           <div style="margin-bottom: 5px" class="input-group">
                                    <div class="col-md-2 col-2 text-left">
                                        <asp:Label ID="Label9" runat="server" Text="Customer Name" style="width:125px;"></asp:Label>   
                                    </div>
                                     <div class="col-lg-5 col-5">
                                         <div class="input-group" >
                                             <asp:TextBox ID="txtCustomerName" runat="server" CssClass="form-control" AutoCompleteType="Disabled" style="text-transform:uppercase;"  onkeydown = "return (event.keyCode!=13);" onfocus="disableautocompletion(this.id);"></asp:TextBox>
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtCustomerName"
                                                  ForeColor="Red" ValidationGroup="grpSave" Display="Dynamic"
                                                 ErrorMessage="Required Field"></asp:RequiredFieldValidator>
                                         </div>
                                     </div>
                             </div>
                             ...
                             <div style="margin-bottom: 5px" class="input-group">
                                    <div class="col-md-2 col-2 text-left">
                                     ...
                                     <div class="col-lg-5 col-5">
                                         <div class="input-group" >
                                             <asp:TextBox ID="txtQty" runat="server" CssClass="form-control decimalnumbers-only" Width="75px" ValidationGroup="grpSave"   onkeydown = "return (event.keyCode!=13);" AutoCompleteType="Disabled" onfocus="disableautocompletion(this.id);"></asp:TextBox>
                ...
                <div class="col-sm-12 text-center">
                               ...
                               <asp:GridView ID="gvPicked" CssClass="table table-bordered active active" DataKeyNames="vRecNum" AutoGenerateColumns="false" runat="server" OnRowDeleting="gvPickedItems_RowDeleting">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ReceiptNo" HeaderText="No." ItemStyle-Width="12%" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="CustomerName" HeaderText="Name" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Center" />
...
<script type="text/javascript">
    function ShowSuccessMsg() {
        $(function () {
            $("#messageDiv").dialog({
                title: "Data Entry - Complimentary",
                width: '335px',
                buttons: {
                    Close: function () {
                        $(this).dialog('close');
