<%@ Page Title="Stock Transfer for Approval" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ListStockTransfer.aspx.cs" Inherits="CSI.ListStockTransfer" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
     <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5>List of Stock Trasnfer for Approval</h5>
                </div>
                <div class="col-sm-6">
                                  ...
                                  <div style="margin-bottom: 5px" class="input-group">
                                      ...
                                      <div class="col-lg-4 col-4">
                                        ...
                                        <div class="col-lg-1 col-1 text-right">
                                             <div class="input-group" >
                                                 <asp:Button ID="btnPost" runat="server" Text="Approve" CssClass="btn btn-primary" ValidationGroup="grpSave" OnClientClick="if(Page_ClientValidate()) ShowProgress()" OnClick="btnPost_Click"/>
                                             </div>
                                         </div>
                                 </div>
                                <div style="margin-bottom: 5px" class="input-group">
