<%@ Page Title="Expired Items" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ListExpiredItems.aspx.cs" Inherits="CSI.ListExpiredItems" %>
                            ...
                            <div class="card-header">
                             ...
                             <div class="card-body">
                                <div class="col-sm-12">
                                        ...
                                        <asp:GridView ID="gvExpired" ClientIDMode="Static" class="table table-bordered table-hover" EmptyDataText="No Record Found" AutoGenerateColumns="false" runat="server" OnPreRender="gvExpired_PreRender">
                                            <Columns>
    ...
    <script>
        $(function () {
            $("#<%= gvExpired.ClientID%>").DataTable({
                ...
                "autoWidth": false,
                "responsive": true,
            }).buttons().container().appendTo('#gvExpired_wrapper .col-md-6:eq(0)');;
        });
    </script>
