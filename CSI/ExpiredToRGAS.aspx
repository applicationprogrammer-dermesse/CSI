<%@ Page Title="Expired to RGAS" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ExpiredToRGAS.aspx.cs" Inherits="CSI.ExpiredToRGAS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5>List of Expired Items(For transfer to RGAS)</h5>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-sm-12">
                                ...
                                <asp:GridView ID="gvInventoryDetailedHO" runat="server" ClientIDMode="Static" DataKeyNames="HeaderID" class="table table-bordered table-hover" AutoGenerateColumns="false" OnPreRender="gvInventoryDetailedHO_PreRender" OnRowCommand="gvInventoryDetailedHO_RowCommand">
                                    <Columns>
                                        <asp:BoundField DataField="HeaderID" HeaderText="ID" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center"  ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol">
