<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AdjustmentEntry.aspx.cs" Inherits="CSI.AdjustmentEntry" %>
            ...
            <div class="row">
                <div class="col-12">
                         ...
                         <div class="card">
                            <div class="card-header">
                              ...
                              <div style="margin-bottom: 5px" class="input-group">
                                  ...
                                  <div class="col-lg-4 col-4">
                                    ...
                                    <div class="col-lg-1 col-1 text-right">
                                         <div class="input-group" >
                                             <asp:Button ID="btnPost" runat="server" Text="SUBMIT" CssClass="btn btn-primary" OnClick="btnPost_Click" OnClientClick="" />
                                         </div>
                                     </div>
                             </div>
                             ...
                             <div style="margin-bottom: 5px" class="input-group">
                                    <div class="col-md-2 col-2 text-left">
                                     ...
                                     <div class="col-lg-5 col-5">
                                         <div class="input-group" >
                                             <asp:TextBox ID="txtQty" runat="server" CssClass="form-control" Width="75px" ValidationGroup="grpSave"  AutoCompleteType="Disabled"></asp:TextBox>
                                             <asp:Label ID="Label8" runat="server" ForeColor="Maroon" Text="NOTE: Put a negative sign (-) if adjustment is deduction"></asp:Label>
                            ...
                            <div style="margin-bottom: 5px" class="input-group">
                                    <div class="col-md-2 col-2 text-left">
                                        <asp:Label ID="Label9" runat="server" Text="Reason" style="width:125px;"></asp:Label>   
                                    </div>
                                     <div class="col-lg-5 col-5">
                                         <div class="input-group" >
                                             <asp:TextBox ID="txtReason" runat="server" CssClass="form-control" Width="375px" ValidationGroup="grpSave"  AutoCompleteType="Disabled"></asp:TextBox>
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtQty" ForeColor="Red" ValidationGroup="grpSave" Display="Dynamic"
                                                 ErrorMessage="Required Field"></asp:RequiredFieldValidator>
                                         </div>
                                     </div>
                             </div>
                ...
                <div class="col-sm-12 text-center">
                               ...
                               <asp:GridView ID="gvPicked" CssClass="table table-bordered active active" DataKeyNames="vRecNum" AutoGenerateColumns="false" runat="server" OnRowDeleting="gvPickedItems_RowDeleting">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TransactionNo" HeaderText="No." ItemStyle-Width="14%" ItemStyle-HorizontalAlign="Center" />
