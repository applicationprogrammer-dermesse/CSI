<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="StockUsedDataEntry.aspx.cs" Inherits="CSI.StockUsedDataEntry" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
     <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5>Supplies Stock Used Data Entry</h5>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="card-header">
                                    ...
                                    <div class="col-md-2 col-2 text-left">
                                     ...
                                     <div class="col-lg-5 col-5">
                                         <div class="input-group" >
                                             ...
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddCategory" InitialValue="0" ForeColor="Red" ValidationGroup="grpSave"
                                              Display="Dynamic"    ErrorMessage="Please select category"></asp:RequiredFieldValidator>
                                         </div>
                                     </div>
                             ...
                             <div style="margin-bottom: 5px" class="input-group">
                                    ...
                                    <div class="col-sm-4 col-4">
                                         <div class="input-group" >
                                             <asp:Button ID="btnDhow" runat="server" Text="Show Batches"  ValidationGroup="grpShow" CssClass="btn btn-sm btn-secondary" OnClick="btnDhow_Click" />
                                                 ...
                                                 ErrorMessage="Please select item"></asp:RequiredFieldValidator>
                                               <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtBalance" ForeColor="Red" ValidationGroup="grpSave"
                                             Display="Dynamic" ErrorMessage="Please select batch"></asp:RequiredFieldValidator>
                                        </div>
                                     </div>
                              ...
                              <div style="margin-bottom: 5px" class="input-group">
                                ...
                                <div style="margin-bottom: 5px" class="input-group">
                                    <div class="col-md-2 col-2 text-left">
                                     ...
                                     <div class="col-lg-3 col-3">
                                         <div class="input-group" >
                                             <asp:TextBox ID="txtTransactionDate" runat="server" CssClass="form-control txtDate" Width="105px" ValidationGroup="grpSave" AutoPostBack="true"  AutoCompleteType="Disabled" OnTextChanged="txtTransactionDate_TextChanged"></asp:TextBox>
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtTransactionDate" ForeColor="Red" ValidationGroup="grpSave"
                                ...
                                <div style="margin-bottom: 5px" class="input-group">
                                    <div class="col-md-2 col-2 text-left">
                                        <asp:Label ID="Label8" runat="server" Text="Series No.(In SMS)" style="width:125px;"></asp:Label>   
                                    </div>
                                     <div class="col-lg-7 col-7">
                                         <div class="input-group" >
                                             <asp:DropDownList ID="ddSeriesNo" runat="server"  CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddSeriesNo_SelectedIndexChanged"></asp:DropDownList>
                                             <asp:CheckBox ID="ckHEoption" CssClass="form-check" runat="server" Checked="true" Text="&nbsp;&nbsp;Mandatory if High End(Uncheck if not encoded in SMS)"/>
                                         </div>
                                     </div>
                             </div>
                                ...
                                <div style="margin-bottom: 5px" class="input-group">
                                    <div class="col-md-2 col-2 text-left">
                                        <asp:Label ID="Label9" runat="server" Text="Patient Name (In SMS)" style="width:125px;"></asp:Label>   
                                    </div>
                                     <div class="col-lg-5 col-5">
                                         <div class="input-group" >
                                             <asp:TextBox ID="txtPatientName" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                                         </div>
                                     </div>
                             </div>
                ...
                <div class="col-sm-12 text-center">
                               ...
                               <asp:GridView ID="gvPicked" CssClass="table table-bordered active active" DataKeyNames="vRecNum" AutoGenerateColumns="false" runat="server" OnRowDeleting="gvPickedItems_RowDeleting">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ReceiptNo" HeaderText="No." ItemStyle-Width="14%" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="CustomerName" HeaderText="Customer Name" ItemStyle-Width="12%" ItemStyle-HorizontalAlign="Center" />
                                        ...
                                        <asp:BoundField HeaderText="Batch No." DataField="vBatchNo"  HtmlEncode="false" ItemStyle-Width="8%">
                                           ...
                                           <asp:BoundField DataField="vDateEncoded" HeaderText="Transaction <br />Date" HtmlEncode="false" DataFormatString="{0:MM/dd/yyyy}" ReadOnly="True">
                 ...
                 <div class="loading" align="center" style="margin-top:100px;">
                        ...
                        <%--<img src="images/ajax-loader.gif" alt=""  />--%>
                         ...
                         <br />
                         <asp:Label ID="Label10" runat="server" Text="Please wait" ForeColor="Red"></asp:Label>
