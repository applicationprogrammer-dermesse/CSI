...
namespace CSI
{
    public partial class ReportIssuance : System.Web.UI.Page
    {
        ...
        protected void gvIssuance_PreRender(object sender, EventArgs e)
        {
            if (gvIssuance.Rows.Count > 0)
            {
                gvIssuance.UseAccessibleHeader = true;
                gvIssuance.HeaderRow.TableSection = TableRowSection.TableHeader;
                gvIssuance.FooterRow.TableSection = TableRowSection.TableFooter;
            }
        }
