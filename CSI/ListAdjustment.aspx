<%@ Page Title="Adjustment for Posting" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ListAdjustment.aspx.cs" Inherits="CSI.ListAdjustment" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
     <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5>List of Adjustment for Posting</h5>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                         ...
                         <div class="card">
                            <div class="card-header">
                                ...
                                <div style="margin-bottom: 5px" class="input-group">
                                        <div class="col-md-2 col-2 text-left">
                                            <asp:Label ID="Label1" runat="server" Text="Adjustment No" style="width:125px;"></asp:Label>
                                        </div>
                                         <div class="col-lg-5 col-5">
                                             <div class="input-group" >
                                                 <asp:DropDownList ID="ddAdjustmentNo" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddAdjustmentNo_SelectedIndexChanged" ></asp:DropDownList>
                                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddAdjustmentNo" InitialValue="0" ForeColor="Red" ValidationGroup="grpSave"
                                                     ErrorMessage="Please select Adjustment No"></asp:RequiredFieldValidator>
                                             </div>
                                         </div>
                                 </div>
                             ...
                             <div class="card-body">
                                <div class="col-sm-12">
                                   <%-- <div class="col-sm-12 text-center">--%>
                                        ...
                                        <asp:GridView ID="gvPicked" ClientIDMode="Static" CssClass="table table-bordered active active" DataKeyNames="vRecNum" AutoGenerateColumns="false" runat="server" OnPreRender="gvPicked_PreRender">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TransactionNo" HeaderText="No." ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center" />
                                        ...
                                        <asp:BoundField DataField="Remarks" HeaderText="Reason" ReadOnly="True">
                                                <HeaderStyle Width="10%" HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Center"  />
                                            </asp:BoundField>
