...
namespace CSI
{
    public partial class ListRRwithPOforPosting : System.Web.UI.Page
    {
        ...
        protected void gvRR_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            try
            {
                ...
                TextBox txtvQtyReceived = (TextBox)row.FindControl("txtvQtyReceived");
                ...
                string sql = @"Update ITEM_RREntryWithPO set sup_RetailCost=@sup_RetailCost, vQtyReceived=@vQtyReceived,TotalAmount=@TotalAmount where RecNum = @RecNum";
                using (SqlConnection conn = new SqlConnection(connString))
                {
                    ...
                    using (SqlCommand cmD = new SqlCommand(sql, conn))
                    {
                        ...
                        cmD.Parameters.AddWithValue("@vQtyReceived", txtvQtyReceived.Text);
        ...
        protected void gvRR_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    string connString = System.Configuration.ConfigurationManager.ConnectionStrings["MyConnCSI"].ConnectionString;
                    string sql = @"Delete from ITEM_RREntryWithPO  where RecNum='" + RecNo + "'";
                    using (SqlConnection conn = new SqlConnection(connString))
                    {
                        conn.Open();
